...
#def generate_rpc_buffer_header():
    ...
    #output_dir = path(options.PROJECT_PREFIX).joinpath('Arduino', options.PROJECT_PREFIX)
...
#def generate_command_processor_header():
    ...
    #sketch_dir = path(options.PROJECT_PREFIX).joinpath('Arduino', options.PROJECT_PREFIX)
    #lib_dir = path(options.PROJECT_PREFIX).joinpath('Arduino', 'library')
    #input_classes = ['BaseNode', 'Node']
    #input_headers = [lib_dir.joinpath('BaseNode.h'),
                     #sketch_dir.joinpath('Node.h')]

    #output_header = path(options.PROJECT_PREFIX).joinpath('Arduino', options.PROJECT_PREFIX,
...
#def generate_python_code():
    ...
    #sketch_dir = path(options.PROJECT_PREFIX).joinpath('Arduino', options.PROJECT_PREFIX)
    #lib_dir = path(options.PROJECT_PREFIX).joinpath('Arduino', 'library')
    #output_file = path(options.PROJECT_PREFIX).joinpath('node.py')
    #input_classes = ['BaseNode', 'Node']
    #input_headers = [lib_dir.joinpath('BaseNode.h'),
                     #sketch_dir.joinpath('Node.h')]
